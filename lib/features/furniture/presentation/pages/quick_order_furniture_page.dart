...
class QuickOrderFurniturePage extends StatelessWidget {
  const QuickOrderFurniturePage({super.key});
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: const [
                  Text(
                    'خدمة نقل/تنظيف الأثاث السريعة',
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.greyDark),
                  ),
                  SizedBox(height: 8),
                  Text(
                    'اختر نوع القطعة وسنجهز طلبك مباشرة.',
