    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSection(
            title: 'مقدمة',
            content: 'نحن في واشي واش نحترم خصوصية مستخدمينا ونلتزم بحماية المعلومات الشخصية التي تشاركونها معنا. تشرح هذه السياسة كيفية جمع واستخدام وحماية المعلومات الخاصة بك عند استخدام تطبيقنا وخدماتنا.',
            icon: Icons.security,
          ),
